...
class FinedustFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        //cl01 클릭 시 날씨 화면 전환
        root.findViewById<ConstraintLayout>(R.id.nav_weather).setOnClickListener{
        ...
        root.findViewById<TextView>(R.id.nav_setting).setOnClickListener{
        ...
        root.findViewById<ConstraintLayout>(R.id.nav_findust).setOnClickListener{
